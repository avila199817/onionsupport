...
- Estabilidad: la primera comparación remota detectó CLS 0,0504 en escritorio al insertar tardíamente el formulario después del hero. Ahora se inserta antes de Contacto, tras servicios, método y presupuesto, conservando `#incidencia` y sus accesos directos. Una prueba retiene la descarga real del módulo en fuente y build y comprueba que Servicios mantiene su posición al montar el formulario.
