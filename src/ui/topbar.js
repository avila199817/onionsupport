...
export const TopbarUI = (() => {
  ...
  let cache = new Map();
   ...
   /* =========================================================
      TEMPLATE / MOUNT
      TOPBAR = HERMANO DEL SIDEBAR
      SHELL ROOT = #app-shell / .layout
   ========================================================= */
   ...
   /* =========================================================
      MAIN CONTENT (solo referencia secundaria)
   ========================================================= */
   ...
   /* =========================================================
      MOUNT TOPBAR
      - topbar hermano del sidebar
      - insertado dentro del shell global
   ========================================================= */
   function mountTopbar() {
     let topbar = document.getElementById("topbar");
     if (topbar) return topbar;
   
     const shellRoot = getShellRootEl();
