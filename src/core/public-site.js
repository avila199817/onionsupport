...
export const PUBLIC_PAGES = Object.freeze([
  Object.freeze({ path: "/", file: "index.html", label: PUBLIC_SITE.name, title: "Soporte informático y asistencia técnica | Onion Support", description: "Soporte informático para particulares, autónomos y empresas. Asistencia remota, reparación, redes y mantenimiento IT con atención rápida, clara y profesional.", indexable: true }),
  ...PUBLIC_SERVICES,
