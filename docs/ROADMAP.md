...
| Modales | Apertura de los cuatro dominios en una sesión; lifecycle compartido de foco, pila, Escape y scroll | `src/features/entity-overlay/index.js`, `modal-lifecycle.js` y [contrato modal](UI_MODAL_SYSTEM.md) |
