...
| Escape HTML de nodos de texto y atributos (`escapeHtml`) | `src/core/escape-html.js` | Templates, controladores y el shell modal lo importan; nunca recorta ni colapsa contenido. Quedan dos copias (`views/agenda`, `views/public`) listadas en el contrato para su propia unidad. |
