/* =========================================================
   ...
   Contrato:
   - Cuenta es self-only.
   - No expone APIs ficticias de edición de perfil/preferencias.
   - No expone sesiones/meta sin consumidor UI.
...
export async function uploadCuentaAvatar(file, { timeout = CUENTA_UPLOAD_TIMEOUT } = {}) {
