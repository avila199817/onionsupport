...
Repository Integrity, validación confiable del candidato, preview y comparación de Home son correctos. La PR se fusionó en [`822784b34b4a35917e79cbc6c4977bf85c370f69`](https://github.com/avila199817/onionsupport/commit/822784b34b4a35917e79cbc6c4977bf85c370f69); el [despliegue de producción 34225392812](https://github.com/avila199817/onionsupport/actions/runs/34225392812) finalizó correctamente, incluidos bytes canónicos y contratos de cabeceras, routing, backend y CORS. La [verificación independiente 34225693523](https://github.com/avila199817/onionsupport/actions/runs/34225693523) también finalizó correctamente: rebuild reproducible, navegador, bytes publicados, contratos productivos y Google Measurement/consentimiento. La disponibilidad posterior confirmó tres rondas sin fallos. El contrato de mantenimiento está en [UI_MODAL_SYSTEM.md](UI_MODAL_SYSTEM.md).
...
| Apertura de detalle centralizada en los cuatro dominios | Desplegada y verificada en producción, con gate independiente correcto | [Entrega 2026-09-08](releases/2026-09-08-single-modal-session.md): controladores/templates reales, sesión única, origen estable, lecturas iniciales deduplicadas y matriz de navegador. No sustituye F1 autenticado. |
...
En la comparación controlada de Home público de esta entrega, el [run 34224888801](https://github.com/avila199817/onionsupport/actions/runs/34224888801) mantiene rendimiento mediano **86 móvil / 99 escritorio** y CLS **0** en base y candidato. Los avisos móviles de rendimiento/LCP aparecen en ambas revisiones. Las cifras, condiciones y límites completos están en el [registro del 2026-09-08](releases/2026-09-08-single-modal-session.md#comparación-de-rendimiento-de-home-público); no son una medición del Home privado ni de producción y no cierran el diagnóstico móvil.

Tras desplegar `822784b3`, el [run Lighthouse 34225693580](https://github.com/avila199817/onionsupport/actions/runs/34225693580) completó cinco muestras por URL y perfil sin reintentos. Las medianas de rendimiento de portada/acceso/servicio fueron **93/96/99 en móvil** y **99/99/100 en escritorio**, con CLS **0**. El único aviso de ese run fue el LCP mediano de `/login` móvil, **2.744 ms frente a 2.500 ms**. El acceso mantuvo `noindex` en HTML y HTTP en todas sus muestras. El [registro de release](releases/2026-09-08-single-modal-session.md#lighthouse-de-producción-después-del-despliegue) conserva medianas, peores muestras y jobs; este resultado no demuestra causalidad de la refactorización ni cierra el diagnóstico de rendimiento.
