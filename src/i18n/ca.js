/* =========================================================
   ...
   - accions comunes
   - auth / estats / errors
   - suport complet per sidebar i topbar
...
const ca = {
  ...
  app: {
    ...
    notFound: {
      ...
      message:
        "La ruta que intentes obrir no existeix o ja no està disponible.",
  ...
  home: {
    title: "Inici",
    welcome:
      "Benvingut a Onion Support",
    description:
      "El teu panell de gestió i suport està llest.",
  ...
  auth: {
    ...
    session: {
      ...
      invalid:
        "La sessió no és vàlida.",
      required:
        "Has d'iniciar sessió per continuar.",
      restored:
        "Sessió restaurada correctament",
    },
  ...
  toast: {
    ...
    generic: {
      success:
        "Acció completada correctament",
      error:
        "S'ha produït un error inesperat",
      warning:
        "Revisa la informació abans de continuar",
      info:
        "Hi ha informació nova disponible",
      loading:
  ...
  feedback: {
    success: {
      ...
      created:
        "Element creat correctament",
      deleted:
        "Element eliminat correctament",
      sent:
        "Enviament completat correctament",
    },
    ...
    error: {
      generic:
        "S'ha produït un error inesperat",
      network:
        "Error de xarxa. Comprova la connexió.",
      server:
        "El servidor no ha respost correctament",
      timeout:
  ...
  validation: {
    ...
    invalid:
      "Valor no vàlid",
    tooShort:
      "El valor és massa curt",
    tooLong:
      "El valor és massa llarg",
  },

  table: {
    empty:
      "No hi ha registres disponibles",
    loading:
      "Carregant taula...",
    columns:
      "Columnes",
