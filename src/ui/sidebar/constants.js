/* =========================================================
   ...
   ONION SUPPORT · SIDEBAR CONSTANTS · EXTREME 10/10
   ...
   - cero mutaciones runtime fuera de freeze interno
...
export const SIDEBAR_MODULE_NAME =
  "SidebarUI";

export const SIDEBAR_MODULE_KEY =
  "sidebar";

export const SIDEBAR_COMPONENT_NAME =
  "sidebar";

export const SIDEBAR_CONSTANTS_VERSION =
  "sidebar-constants-v16-extreme-shell-router-token-safe";
...
export const SIDEBAR_DOM_SCOPE =
  `${SCOPE}:dom`;

export const SIDEBAR_CORE_SCOPE =
  `${SCOPE}:core`;

export const SIDEBAR_EVENTS_SCOPE =
  `${SCOPE}:events`;

export const SIDEBAR_FALLBACK_SCOPE =
  `${SCOPE}:fallback`;

export const SIDEBAR_STATE_SCOPE =
  `${SCOPE}:state`;

export const SIDEBAR_DROPDOWN_SCOPE =
  `${SCOPE}:dropdown`;

export const SIDEBAR_VISIBILITY_SCOPE =
  `${SCOPE}:visibility`;

export const SIDEBAR_ACTIONS_SCOPE =
  `${SCOPE}:actions`;

export const SIDEBAR_TEMPLATE_SCOPE =
  `${SCOPE}:template`;

export const SIDEBAR_USER_SCOPE =
  `${SCOPE}:user`;

export const SIDEBAR_INDICATOR_SCOPE =
  `${SCOPE}:indicator`;

export const SIDEBAR_REPAIR_SCOPE =
  `${SCOPE}:repair`;

export const SIDEBAR_DIAGNOSTICS_SCOPE =
  `${SCOPE}:diagnostics`;
...
export const SIDEBAR_MOBILE_BREAKPOINT =
  MOBILE_BREAKPOINT;

export const SIDEBAR_NARROW_BREAKPOINT =
  640;

export const SIDEBAR_COMPACT_BREAKPOINT =
  420;
...
export const SIDEBAR_TRANSITION_MS =
  380;

export const SIDEBAR_VISUAL_SYNC_DELAY_MS =
  32;

export const SIDEBAR_VISUAL_SYNC_AFTER_NAV_MS =
  80;

export const SIDEBAR_VISUAL_SYNC_AFTER_RENDER_MS =
  96;

export const SIDEBAR_VISUAL_SYNC_AFTER_TRANSITION_MS =
  SIDEBAR_TRANSITION_MS + 50;

export const SIDEBAR_HOVER_FLUSH_MS =
  96;

export const SIDEBAR_BIND_DEDUP_WINDOW_MS =
  250;

export const SIDEBAR_REPAIR_DEDUP_WINDOW_MS =
  180;

export const SIDEBAR_REFRESH_DEDUP_WINDOW_MS =
  180;

export const SIDEBAR_SYNC_DEDUP_WINDOW_MS =
  90;

export const SIDEBAR_INDICATOR_DEFAULT_DELAY_MS =
  40;

export const SIDEBAR_INDICATOR_RECALC_DELAY_MS =
  32;

export const SIDEBAR_INDICATOR_SETTLED_DELAY_MS =
  SIDEBAR_TRANSITION_MS + 36;

export const SIDEBAR_DROPDOWN_CLOSE_DELAY_MS =
  0;

export const SIDEBAR_DROPDOWN_FOCUS_DELAY_MS =
  24;

export const SIDEBAR_DROPDOWN_OUTSIDE_POINTER_DELAY_MS =
  16;

export const SIDEBAR_RESIZE_DEBOUNCE_MS =
  120;

export const SIDEBAR_ROUTER_SETTLED_DELAY_MS =
  140;

export const SIDEBAR_AUTH_SETTLED_DELAY_MS =
  90;

export const SIDEBAR_LANG_SETTLED_DELAY_MS =
  60;

export const SIDEBAR_THEME_SETTLED_DELAY_MS =
  60;
...
export const SIDEBAR_ROOT_ID =
  "sidebar";

export const SIDEBAR_ROOT_LEGACY_ID =
  "app-sidebar";

export const SIDEBAR_MOUNT_ID =
  "sidebar-mount";

export const SIDEBAR_NAV_ID =
  "sidebar-nav";

export const SIDEBAR_MENU_ID =
  "sidebar-menu";

export const SIDEBAR_RECENTS_ID =
  "sidebar-recents";

export const SIDEBAR_FOOTER_ID =
  "sidebar-footer";

export const SIDEBAR_INDICATOR_ID =
  "sidebar-active-indicator";

export const SIDEBAR_SCROLL_ID =
  "sidebar-scroll";

export const SIDEBAR_CONTENT_ID =
  "sidebar-content";
...
export const SIDEBAR_TOGGLE_LEGACY_ID =
  "sidebarToggle";

export const SIDEBAR_MOBILE_TOGGLE_ID =
  "toggleSidebarMobile";

export const SIDEBAR_MOBILE_TOGGLE_LEGACY_ID =
  "sidebarMobileToggle";

export const SIDEBAR_LOGO_ID =
  "homeLink";

export const SIDEBAR_LOGO_LEGACY_ID =
  "sidebarLogo";

export const USER_SECTION_ID =
  "sidebar-user";

export const USER_TOGGLE_ID =
  "userToggle";

export const USER_TOGGLE_LEGACY_ID =
  "sidebarUserToggle";

export const USER_DROPDOWN_ID =
  "userDropdown";

export const USER_DROPDOWN_LEGACY_ID =
  "sidebarUserDropdown";

export const LOGOUT_BUTTON_ID =
  "logoutBtn";

export const LOGOUT_BUTTON_LEGACY_ID =
  "sidebarLogout";

export const SIDEBAR_AVATAR_ID =
  "sidebar-avatar";

export const SIDEBAR_AVATAR_LEGACY_ID =
  "sidebarAvatar";
...
export const SIDEBAR_NAME_ID =
  "sidebar-name";

export const SIDEBAR_NAME_LEGACY_ID =
  "sidebarName";

export const SIDEBAR_USER_PLAN_ID =
  "sidebarUserPlan";

export const SERVER_NAV_ID =
  "sidebar-server-link";
...
export const INCIDENCIAS_ROUTE =
  "/incidencias";

export const FACTURAS_ROUTE =
  "/facturas";

export const USUARIOS_ROUTE =
  "/usuarios";

export const CLIENTES_ROUTE =
  "/clientes";

export const CUENTA_ROUTE =
  "/cuenta";

export const AJUSTES_ROUTE =
  "/ajustes";
...
export const SIDEBAR_ROUTE_ALIASES =
  freeze({
    "/":
      HOME_ROUTE,
...
function applyRouteAlias(pathname = DEFAULT_ROUTE) {
  ...
  if (SIDEBAR_ROUTE_ALIASES[clean]) {
    return SIDEBAR_ROUTE_ALIASES[clean];
  }
...
export function normalizeSidebarPublicPath(path = DEFAULT_ROUTE, options = {}) {
  ...
  const preserveSearch =
    opts.preserveSearch !== false;

  const preserveHash =
    opts.preserveHash === true;
...
export const SIDEBAR_PUBLIC_ROUTES =
  freeze([
    LOGIN_ROUTE,
    ACTIVATE_ACCOUNT_ROUTE,
    RESET_PASSWORD_ROUTE,
...
export const SIDEBAR_TECHNICAL_PUBLIC_ROUTES =
  freeze([
    ACTIVATE_ACCOUNT_ROUTE,
    RESET_PASSWORD_CONFIRM_ROUTE,
  ]);

export const SIDEBAR_AUTH_ROUTES =
  freeze([
    LOGIN_ROUTE,
    ACTIVATE_ACCOUNT_ROUTE,
    RESET_PASSWORD_ROUTE,
...
export const SIDEBAR_SHELL_HIDDEN_ROUTES =
  freeze([
    LOGIN_ROUTE,
    ACTIVATE_ACCOUNT_ROUTE,
    RESET_PASSWORD_ROUTE,
...
export const SIDEBAR_PRIVATE_ROUTES =
  freeze([
    HOME_ROUTE,
    INCIDENCIAS_ROUTE,
    FACTURAS_ROUTE,
...
export function isSidebarPublicRoute(path = DEFAULT_ROUTE) {
  return SIDEBAR_PUBLIC_ROUTES.includes(
    normalizeSidebarRoute(path)
  );
}

export function isSidebarAuthRoute(path = DEFAULT_ROUTE) {
  return SIDEBAR_AUTH_ROUTES.includes(
    normalizeSidebarRoute(path)
  );
}

export function isSidebarShellHiddenRoute(path = DEFAULT_ROUTE) {
  return SIDEBAR_SHELL_HIDDEN_ROUTES.includes(
    normalizeSidebarRoute(path)
  );
}

export function isSidebarAdminRoute(path = DEFAULT_ROUTE) {
  return SIDEBAR_ADMIN_ROUTES.includes(
    normalizeSidebarRoute(path)
  );
}
...
export const SIDEBAR_SENSITIVE_QUERY_PARAM_NAMES =
  freeze([
    "token",
    "activationToken",
    "activateToken",
...
export const SIDEBAR_TOKEN_ROUTE_PREFIXES =
  freeze([
    `${ACTIVATE_ACCOUNT_ROUTE}/`,
    `${RESET_PASSWORD_CONFIRM_ROUTE}/`,
  ]);
...
export const SIDEBAR_ACTION_NAVIGATE =
  "navigate";

export const SIDEBAR_ACTION_TOGGLE =
  "toggle-sidebar";

export const SIDEBAR_ACTION_OPEN =
  "open-sidebar";

export const SIDEBAR_ACTION_CLOSE =
  "close-sidebar";

export const SIDEBAR_ACTION_COLLAPSE =
  "collapse-sidebar";

export const SIDEBAR_ACTION_EXPAND =
  "expand-sidebar";

export const SIDEBAR_ACTION_TOGGLE_MOBILE =
  "mobile-sidebar-toggle";

export const SIDEBAR_ACTION_OPEN_MOBILE =
  "open-mobile-sidebar";

export const SIDEBAR_ACTION_CLOSE_MOBILE =
  "close-mobile-sidebar";

export const SIDEBAR_ACTION_TOGGLE_USER =
  "toggle-user-dropdown";

export const SIDEBAR_ACTION_OPEN_USER_MENU =
  "open-user-menu";

export const SIDEBAR_ACTION_CLOSE_USER_MENU =
  "close-user-menu";

export const SIDEBAR_ACTION_REFRESH =
  "refresh-sidebar";

export const SIDEBAR_ACTION_REPAIR =
  "repair-sidebar";

export const SIDEBAR_ACTION_SYNC_USER =
  "sync-user";

export const SIDEBAR_ACTION_SYNC_ACTIVE =
  "sync-active";

export const SIDEBAR_ACTION_ADD_ACCOUNT =
  "add-account";

export const SIDEBAR_ACTION_CHANGE_PLAN =
  "change-plan";

export const SIDEBAR_ACTION_PROFILE =
  "profile";

export const SIDEBAR_ACTION_SETTINGS =
  "settings";

export const SIDEBAR_ACTION_HELP =
  "help";

export const SIDEBAR_ACTION_LOGOUT =
  "logout";
...
export const SIDEBAR_ACTION_ALIASES =
  freeze({
    navigate:
      SIDEBAR_ACTION_NAVIGATE,
...
export const SIDEBAR_STORAGE_KEYS =
  freeze({
    ...
    desktopCollapsedV2:
      `${SIDEBAR_STORAGE_NAMESPACE}.desktopCollapsed`,

    desktopOpen:
      `${SIDEBAR_STORAGE_NAMESPACE}.desktopOpen`,

    mobileOpen:
      `${SIDEBAR_STORAGE_NAMESPACE}.mobileOpen`,

    userDropdownOpen:
      `${SIDEBAR_STORAGE_NAMESPACE}.userDropdownOpen`,

    onionDesktopCollapsed:
      `${SIDEBAR_STORAGE_NAMESPACE_ONION}.desktopCollapsed`,

    onionDesktopOpen:
      `${SIDEBAR_STORAGE_NAMESPACE_ONION}.desktopOpen`,

    onionMobileOpen:
      `${SIDEBAR_STORAGE_NAMESPACE_ONION}.mobileOpen`,

    lastActiveRoute:
      `${SIDEBAR_STORAGE_NAMESPACE}.lastActiveRoute`,

    lastActivePublicPath:
      `${SIDEBAR_STORAGE_NAMESPACE}.lastActivePublicPath`,

    lastResolvedUsername:
      `${SIDEBAR_STORAGE_NAMESPACE}.lastResolvedUsername`,
  });
...
export const SIDEBAR_SEARCH_GLASS_CLASSES =
  freeze({
    active:
      "search-glass-active",

    sidebarStable:
      "sidebar-search-glass-stable",

    topbarStable:
      "topbar-search-glass-stable",

    chromeStable:
      "chrome-search-glass-stable",
  });
...
export const SIDEBAR_DATASET_VALUES =
  freeze({
    true:
      "true",
...
export const SIDEBAR_SHELL_HIDDEN_BODY_CLASSES =
  freeze([
    "route-shell-hidden",
    "auth-screen",
    "route-auth",
...
export const SIDEBAR_SHELL_VISIBLE_BODY_CLASSES =
  freeze([
    "route-shell-visible",
    "route-app",
  ]);

export const SIDEBAR_SHELL_DATA_VALUES =
  freeze({
    hidden:
      "hidden",
...
export const SIDEBAR_EVENTS =
  freeze({
    ...
    refreshDeduped:
      "sidebar:refresh:deduped",

    domMounted:
      "sidebar:dom:mounted",

    domRevealed:
      "sidebar:dom:revealed",
    ...
    uiCollapsedSet:
      "sidebar:ui:collapsed:set",

    activeItemSynced:
      "sidebar:active:item:synced",

    activeItemOverridden:
    ...
    dropdownNavigationRequest:
      "sidebar:dropdown:navigation:request",

    fallbackAction:
      "sidebar:fallback:action",

    userToggleDirect:
      "sidebar:user-toggle:direct",

    menuInteractionRestored:
...
export const SIDEBAR_OBSERVED_APP_EVENTS =
  freeze([
    "app:ready",
    "app:boot:ready",
    "app:boot:complete",
...
export const SIDEBAR_OBSERVED_AUTH_EVENTS =
  freeze([
    "auth:change",
    "auth:updated",
...
export const SIDEBAR_OBSERVED_ROUTER_EVENTS =
  freeze([
    "router:bound",
...
export const SIDEBAR_BLOCKED_ROUTER_EVENTS =
  freeze([
    "router:shell:repair",
    "router:shell:state",
    "router:shell:change",
...
export const SIDEBAR_ADMIN_ROLE_KEYS =
  freeze([
    "admin",
    "administrator",
    "administrador",
...
export const SIDEBAR_SUPPORT_ROLE_KEYS =
  freeze([
    "support",
    "soporte",
    "agent",
...
export const SIDEBAR_MANAGER_ROLE_KEYS =
  freeze([
    "manager",
    "gestor",
    "gerente",
...
export const SIDEBAR_CLIENT_ROLE_KEYS =
  freeze([
    "client",
    "cliente",
    "customer",
...
export const SIDEBAR_ADMIN_PERMISSION_KEYS =
  freeze([
    "*",
...
export const SIDEBAR_SUPPORT_PERMISSION_KEYS =
  freeze([
    "tickets.read",
    "tickets:read",
    "tickets.manage",
...
export const SIDEBAR_ADMIN_FLAG_KEYS =
  freeze([
    "isAdmin",
    "admin",
    "is_admin",
...
export const SIDEBAR_SUPPORT_FLAG_KEYS =
  freeze([
    "isSupport",
    "support",
    "is_support",
...
export const SIDEBAR_ROLE_GROUPS =
  freeze({
    admin:
...
export const SIDEBAR_HANDLED_FLAG =
  "__onionSidebarHandled";

export const SIDEBAR_EVENTS_HANDLED_FLAG =
  "__onionSidebarEventsHandled";

export const SIDEBAR_HANDLED_REASON_FLAG =
  "__onionSidebarReason";

/* =========================================================
   I18N KEYS
========================================================= */

export const SIDEBAR_I18N_KEYS =
  freeze({
    ariaMain:
      "sidebar.aria.main",
